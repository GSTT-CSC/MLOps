...
def main(datadir):
    ...
    for epoch in range(10):
        ...
        for batch_data in train_loader:
            ...
            Logger.current_logger().report_scalar("Train loss", "series A", iteration=epoch, value=loss.item())
...
if __name__ == "__main__":
    task = Task.init(project_name="Test clearml", task_name="test 1")
    dataset_folder = Dataset.get(dataset_id='8a187959260641e39753f7075b924f14').get_local_copy()
    main(dataset_folder)
